    ...
    implements ActionListener
{
    ...
    String DEV_EMAIL="email@gmail.pt";
    String APP_NAME="Jogo de teste...";    
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // ********************************************
		 ...
		 try {
		     String s= "Chosen option: ";
                     // que operacao esta seleccionada?
                     if (rbt1.isSelected()) { // This is answer one
			s+= RESP1;
                     }
                     else if(rbt2.isSelected()) { // This is the second answer
			 s+= RESP2;
                     }

                     else if(rbt3.isSelected()) { // This is another answer
			 s+= RESP3;
                     }
                     
                     else if(rbt4.isSelected()) { // Maybe
			 s+= RESP4;
                     }

                     else if(rbt5.isSelected()) { // Do not know
			 s+= RESP5;
                     }
                     
                     // As opções de jogo poderiam continuar aqui...
